...
if [[ -f ~/pika_proxy ]]; then
  mv ~/pika_proxy bin
fi
export LD_LIBRARY_PATH=./bin

# Usage: pika_proxy [-h] [-t local_ip -p local_port -i master_ip -o master_port -m forward_ip -n forward_port -x forward_thread_num -y forward_passwd]
...
#   example: ./pika_proxy -t 127.0.0.1 -p 12345 -i 127.0.0.1 -o 9221 -m 127.0.0.1 -n 6379 -x 7 -f 0 -s 0 -w abc -l ./log -r ./rsync_dump -d

rm -rf ./rsync_dump/
rm -rf ./sync_log/
./bin/pika_proxy -t 10.33.80.155 -i 10.33.80.155 -o 13333 -m 10.33.80.155 -n 16379 -x 10 -l ./sync_log/ -r ./rsync_dump
